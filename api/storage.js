// Vercel serverless function — proxies Vercel KV REST API server-side
module.exports = async function handler(req, res) {
  ...
  if (!KV_URL || !KV_TOKEN) {
    // KV not connected — tell client to use localStorage fallback
  ...
  try {
    if (req.method === 'GET') {
      ...
      // Vercel KV returns {"result": storedValue}
